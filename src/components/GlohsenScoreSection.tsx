...
import { Award, Clock, DollarSign, Loader2 } from "lucide-react";
import { motion } from "framer-motion";
import { GlohsenScoreResultMockup } from "./GlohsenScoreResultMockup";
import { GlohsenScoreProvider } from "./GlohsenScoreContext";

interface GlohsenScoreSectionProps {
  isLoading?: boolean;
  error?: Error | null;
  metrics?: {
    performance: number;
...
const GlohsenScoreSection: React.FC<GlohsenScoreSectionProps> = ({
  isLoading = false,
  error = null,
  metrics = { performance: 89, earnings: 10000000, experience: 92 },
  onShare,
  onDownload,
  onPrint
}) => {
  ...
  if (error) {
    return (
      <div className="p-4 bg-red-50 rounded-md text-red-800" role="alert">
  ...
  return (
    <GlohsenScoreProvider>
      <section 
        className="py-20 bg-gradient-to-b from-[#F5F5F5] to-[#FFFFFF] relative overflow-hidden"
        aria-labelledby="glohsen-score-title"
      >
      {isLoading ? (
          ...
          <div className="glassmorphism rounded-2xl shadow-2xl overflow-hidden transform perspective-1000">
            <div className="bg-gradient-to-r from-[#D4AF37]/20 to-transparent p-10 border-b border-white/20">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto text-center">
                {/* Performance Box */}
                <div className="bg-gradient-to-br from-[#D4AF37] to-[#AA8C2C] p-4 rounded-lg shadow-lg relative overflow-hidden h-56 flex flex-col justify-center">            <div className="relative z-10">
              ...
              <GlohsenScoreResultMockup showFullReport={false} />
            </div>
              ...
              <div className="mt-8 flex justify-center">
                <Link to="/signup">
                  <button className="button-3d bg-f5f5f5 text-d4af37">
