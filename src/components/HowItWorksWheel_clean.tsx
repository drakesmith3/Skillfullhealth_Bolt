...
const HowItWorksWheel: React.FC<SectionProps> = ({ isActive, sectionName, scrollToSection, playClickSound }) => {  
  ...
  return (
    <section
      id={sectionName}
      className={`relative overflow-hidden w-full min-h-screen flex flex-col items-center justify-center px-8 py-12 transition-all duration-700 ${themeStyles.background} ${
    ...
    >
      ...
      <div className="container mx-auto text-center relative z-20">
        <div className="relative mb-8 w-full">
          <h2
            className={`text-5xl lg:text-6xl xl:text-7xl font-black tracking-tight mb-8 relative z-10 transition-all duration-700 ${themeStyles.titleText
            }`}
            style={{ 
              fontFamily: '"Orbitron", "Exo 2", sans-serif',
              textShadow: themeStyles.titleShadow,
      ...
      >
        ...
        {/* Central Light Bulb - Theme Responsive with improved z-index */}
        <div
          ...
          style={{
            ...
            zIndex: 50, // Significantly higher z-index to prevent overlap
        ...
        {/* Interactive rotating wheel with synchronized timing */}        
        <div          
          ref={wheelRef}
            ...
            >
              <div
                ...
                style={{ 
                  ...
                  transform: "rotate(90deg)", // Compensate for wheel's -90deg rotation
                  background: isDark
          ...
          {WHEEL_CONFIG.STEPS.map((step) => (
            <div
              ...
              style={{
                position: "absolute",
                ...step.position,
                width: 'min(160px, 20vw)', // Reduced width to prevent overlap
                transformStyle: "preserve-3d",
                zIndex: step.id === 1 ? 30 : step.id === 2 ? 28 : step.id === 3 ? 26 : 24, // Staggered z-index to prevent overlap
            ...
            >
              ...
              >
                <div
                  ...
                  style={{
                    transformOrigin: "center center", 
                    width: 'min(45px, 5.6vw)', // Reduced size to prevent overlap
                    height: 'min(45px, 5.6vw)',
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    style={{
                      width: 24, // Reduced size to fit better in smaller icons
                      height: 24, // Reduced size to fit better in smaller icons
      ...
      {/* Optimized dynamic CSS for theme-specific animations */}
      <style>
        {`
