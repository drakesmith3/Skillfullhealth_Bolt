...
const AccountSettings = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => setShowFooter(true), 1000); // Delay footer
  ...
  return (
    <div className="min-h-screen bg-f5f5f5 flex flex-col">
      <PreHeader currentPage="account settings" />
      <main className="container mx-auto px-4 py-8 mt-16 flex-grow"> {/* Added mt-16 for PreHeader and flex-grow */}
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 md:col-span-9">
            <Card className="p-6 shadow-lg">
              <h1 className="text-2xl font-bold mb-6 text-[#000000e6] border-b pb-2 border-[#D4AF37]">Account Settings</h1>
