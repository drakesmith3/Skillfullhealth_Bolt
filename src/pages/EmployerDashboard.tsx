...
import { Briefcase, ChartBar, PieChart, CreditCard, MessageSquare, FileText, Search, Award, Users } from "lucide-react";
    ...
    >
      <Tabs defaultValue="overview" className="w-full" value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-6 mb-6">
          ...
          <TabsTrigger value="criteria">Criteria Score Analytics</TabsTrigger>
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <Card className="p-6 bg-white dark:bg-gray-800 shadow-md">
            <h2 className="text-xl font-bold mb-6">Recruitment Pipeline</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h3 className="font-medium text-lg">Hiring Status</h3>
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <Progress value={43} className="h-2 bg-gray-200 dark:bg-gray-700" />
                  </div>
        ...
        <TabsContent value="candidates" className="space-y-4">
          <Card className="p-6 bg-white dark:bg-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">View and manage your candidate pipeline here</p>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="criteria" className="space-y-4">
          <Card className="p-6 bg-white dark:bg-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">Criteria score analytics will appear here</p>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="kpi" className="space-y-4">
          <Card className="p-6 bg-white dark:bg-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">KPI analytics data will appear here</p>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="transactions" className="space-y-4">
          <Card className="p-6 bg-white dark:bg-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">Transaction history will appear here</p>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="inbox" className="space-y-4">
          <Card className="p-6 bg-white dark:bg-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">Messages and feedback will appear here</p>
          </Card>
        </TabsContent>
      </Tabs>
    </DashboardLayout>
