...
import { Briefcase, Users, ChartBar, FileText, MessageSquare, PieChart, CreditCard, Search, Award } from "lucide-react";
...
const EmployerDashboard: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
      <PreHeader currentPage="employer dashboard" userName="Hospital Corp." />
      
      <div className="flex-grow flex mt-16">
        {/* Sidebar */}
        <div className="hidden lg:block w-1/4 lg:w-1/5 p-4">
          <EmployerSidebar />
        </div>
        ...
        <div className="w-full lg:flex-1 px-4 py-8 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">Welcome back, Hospital Corp.!</p>
            </div>
          </div>
