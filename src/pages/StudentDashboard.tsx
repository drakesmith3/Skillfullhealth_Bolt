    ...
    >
      <Tabs defaultValue="overview" className="w-full" value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-6 mb-6">
          ...
          <TabsTrigger value="courses">Courses Enrolled In</TabsTrigger>
          <TabsTrigger value="games">Games & Quizzes Stats</TabsTrigger>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-end">
                    <Button size="sm" className="bg-[#D4AF37] hover:bg-amber-500 text-black font-bold">Manage</Button>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={idx} className="border-l-4 border-[#D4AF37] pl-3 py-2">
                      ...
                      <div className="text-sm text-gray-500 dark:text-gray-400">{item.course}</div>
                      <div className="flex justify-between items-center mt-1">
                        <span className="text-xs">{item.date}</span>
                        <span className={`text-xs px-2 py-0.5 rounded-full ${
                          item.status === "Urgent" ? "bg-red-100 text-red-600 dark:bg-red-900 dark:text-red-200" : "bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-200"
                        }`}>{item.status}</span>
                      </div>
                    </div>
                  ))}
        ...
        <TabsContent value="courses" className="space-y-4">
          <Card className="p-6 bg-white dark:bg-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">Courses content will appear here</p>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="games" className="space-y-4">
          <Card className="p-6 bg-white dark:bg-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">Games and quizzes statistics will appear here</p>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="performance" className="space-y-4">
          <Card className="p-6 bg-white dark:bg-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">Performance data and analytics will appear here</p>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="community" className="space-y-4">
          <Card className="p-6 bg-white dark:bg-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">Community interaction will appear here</p>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="wallet" className="space-y-4">
          <Card className="p-6 bg-white dark:bg-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">Wallet and transaction information will appear here</p>
          </Card>
        </TabsContent>
      </Tabs>
    </DashboardLayout>
