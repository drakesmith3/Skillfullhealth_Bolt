      ...
      <Tabs defaultValue="overview" className="w-full" value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="profile" className="space-y-4">
          <Card className="p-6 bg-white dark:bg-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">Profile content will appear here</p>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="courses" className="space-y-4">
          <Card className="p-6 bg-white dark:bg-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">Courses analytics content will appear here</p>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="students" className="space-y-4">
          <Card className="p-6 bg-white dark:bg-gray-800">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">Students analytics data will appear here</p>
          </Card>
        </TabsContent>
